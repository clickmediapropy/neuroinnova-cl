    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-card/80 backdrop-blur-md supports-[backdrop-filter]:bg-card/70 shadow-sm">
      <div className="container flex h-16 md:h-20 items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          >
            <a
              href="https://wa.me/595983309319?text=Hola,%20me%20gustaría%20agendar%20una%20consulta%20para%20tratamiento%20de%20estimulación%20transcraneal."
              target="_blank"
          ...
          >
            <a
              href="https://wa.me/595983309319?text=Hola,%20necesito%20información%20sobre%20consultas%20médicas."
              target="_blank"
              rel="noopener noreferrer"
            >
              WhatsApp 24/7
            ...
            <div className="container py-5 space-y-5">
              ...
              <div className="flex flex-col gap-3 pt-4 border-t border-border/60">
                ...
                <Button
                  ...
                  asChild
                >
                  <a href="https://wa.me/595983309319?text=Hola,%20me%20gustaría%20agendar%20una%20consulta%20para%20tratamiento%20de%20estimulación%20transcraneal." target="_blank" rel="noopener noreferrer">
