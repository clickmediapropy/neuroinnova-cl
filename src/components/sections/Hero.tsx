        ...
        <div className="flex min-h-[calc(100vh-80px)] items-center justify-center py-6 sm:py-12 md:py-16">
          ...
          <div className="flex flex-col justify-center items-center space-y-6 sm:space-y-8 text-center max-w-5xl px-4">
            ...
            <div className="space-y-4 md:space-y-8">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.15]">
                <span className="text-primary font-extrabold">Primer y Único</span><br />
                <span className="text-foreground">Centro de</span><br />
                <span className="text-foreground text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">Neuromodulación</span><br />
              ...
              {/* Sub-headline */}
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-muted-foreground leading-relaxed max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 pt-6 sm:pt-8 md:pt-10 w-full sm:w-auto max-w-lg sm:max-w-none">
              <Button 
                size="lg" 
                className="text-base sm:text-lg md:text-xl px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 h-auto group bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto"
                asChild
              >
                                  <a 
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="text-base sm:text-lg md:text-xl px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 h-auto group border-2 border-primary/30 hover:border-primary hover:bg-primary/5 font-semibold w-full sm:w-auto"
                asChild
              >
