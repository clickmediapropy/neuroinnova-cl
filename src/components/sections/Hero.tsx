...
const Hero = () => {
  ...
  return (
    <section 
      ...
      className="relative overflow-hidden min-h-[600px] sm:min-h-[650px] md:min-h-[700px] bg-gradient-to-br from-background via-background to-primary/5"
      style={{ 
    ...
    >
      ...
      <div className="container relative z-20">
        <div className="flex min-h-[400px] sm:min-h-[500px] md:min-h-[600px] items-center justify-center py-8 sm:py-12 md:py-16">
          {/* CENTERED TEXT ZONE - Full Width */}
          <div className="flex flex-col justify-center items-center space-y-6 sm:space-y-8 text-center max-w-5xl">
            {/* Headline */}
            <div className="space-y-4 md:space-y-8">
              ...
              {/* Sub-headline */}
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-muted-foreground leading-relaxed max-w-4xl px-4 sm:px-0">
            ...
            <div className="inline-flex px-4">
              <div className="px-4 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 bg-primary/10 border border-primary/20 rounded-full">
                <span className="text-sm sm:text-base md:text-lg font-semibold text-primary flex items-center gap-2">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 pt-4 sm:pt-6 md:pt-8 px-4 sm:px-0 w-full sm:w-auto">
              <Button 
                size="lg" 
                className="text-base sm:text-lg md:text-xl lg:text-2xl px-6 sm:px-8 md:px-10 lg:px-12 py-4 sm:py-6 md:py-8 h-auto group bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto"
                asChild
              >
                                  <a 
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="text-base sm:text-lg md:text-xl lg:text-2xl px-6 sm:px-8 md:px-10 lg:px-12 py-4 sm:py-6 md:py-8 h-auto group border-2 border-primary/30 hover:border-primary hover:bg-primary/5 font-semibold w-full sm:w-auto"
                asChild
              >
